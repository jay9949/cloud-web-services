...
const Services = () => {
  const services = [
    {
      id: 1,
      title: "one",
      subtitle: `Pallid nothing made still thing nevermore burden all and, so i a
  ...
  return (
    <div name="services" className="w-full h-full md:h-full bg-slate-300">
      <div className="flex flex-col items-center justify-center max-w-screen-xl mx-auto h-full px-3 py-12">
        ...
        <p className="text-xl py-8 text-gray-600 text-center">
          ...
          something craven. Started usby my marvelled on.
        </p>
