...
const Hero = () => {
  return (
    <div
      name="home"
      className="flex flex-col justify-between w-full h-full pt-20 pb-6 bg-gray-900 text-white text-center md:text-left "
    >
      <div className="grid md:grid-cols-2 max-w-screen-xl m-auto px-3">
        <div className="flex flex-col justify-center md:items-start w-full px-2 py-8">
          ...
          <GreenBtn
            title="sign up"
            className=" capitalize py-3 px-6 mx-auto sm:w-8/12 my-8"
          />
        </div>
